...
import 'package:flutter_smallworld/page/common/smphoto/sm_preview_gesture_utils.dart';
...
class SMPreviewPageViewWidget extends StatefulWidget {
  SMPreviewPageViewWidget({
    Key key,
  ...
  SMPreviewPageViewWidget.builder({
    Key key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    PageController controller,
  ...
  /// model.
  SMPreviewPageViewWidget.custom({
    Key key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    PageController controller,
  ...
  @override
  SMPreviewPageViewWidgetState createState() =>
      SMPreviewPageViewWidgetState();
}

class SMPreviewPageViewWidgetState
    extends State<SMPreviewPageViewWidget>

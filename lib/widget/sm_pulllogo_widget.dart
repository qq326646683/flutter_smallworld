...
typedef LogoRefreshCallback = Future<void> Function();
...
class SMPullLogoWidget extends StatefulWidget {
  ...
  final LogoRefreshCallback onRefresh;
  ...
  @override
  SMPullLogoWidgetState createState() => SMPullLogoWidgetState();
}

/// Contains the state for a [RefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class SMPullLogoWidgetState extends State<SMPullLogoWidget>
    with TickerProviderStateMixin<SMPullLogoWidget> {
  ...
  void didChangeDependencies() {
    _valueColor = _positionController.drive(
      ColorTween(
              begin: Color(0xff5566ee).withOpacity(0.0),
              end: Color(0xee5566).withOpacity(1.0))
          .chain(CurveTween(
              ...
              child: ScaleTransition(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget child) {
                    return Image.asset(
                      SMIcons.EARTH,
                      width: 20 + 60 * _value.value,
                      height: 20 + 60 * _value.value,
                    );
                  },
                ),
              ),

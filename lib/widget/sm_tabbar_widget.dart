...
class SMTabBarWidget extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [SMTabBarWidget] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [SMTabBarWidget] is tapped.
  ///
  /// The callback is applied to the index of the tab where the tap occurred.
  ///
  /// This callback has no effect on the default handling of taps. It's for
  /// applications that want to do a little extra work when a tab is tapped,
  /// even if the tap doesn't change the TabController's index. SMTabBarWidget [onTap]
...
class _TabBarState extends State<SMTabBarWidget> {
  ...
  @override
  void didUpdateWidget(SMTabBarWidget oldWidget) {
  ...
  void _handleTabControllerAnimationTick() {
    ...
    if (!_controller.indexIsChanging && widget.isScrollable) {
      // Sync the SMTabBarWidget's scroll position with the TabBarView's PageView.
      _currentIndex = _controller.index;

...
class _DragDebugWidgetState extends State<DragDebugWidget> {
  ...
  Offset _offset = Offset(ScreenUtil.getInstance().screenWidth > 100 ? ScreenUtil.getInstance().screenWidth - 50 :  ScreenUtil.getInstance().screenWidth, 80);
  ...
  Widget build(BuildContext c) {
    ...
    return StreamBuilder(
      stream: NavigatorUtils.getInstance().streamController.stream,
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.connectionState == ConnectionState.active && Config.DEBUG_ENTER) {
          return Positioned(
            left: _offset.dx - 25,
            top: _offset.dy - 25,
            child:GestureDetector(
              ...
              onTap: () {
                ...
                NavigatorUtils.getInstance().pushNamed(NavigatorUtils.getInstance().getContext(), DebugPage.sName);
              },
              child: Container(
                width: 80,
                height: 80,

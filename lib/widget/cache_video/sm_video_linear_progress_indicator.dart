...
const double _kSMLinearProgressIndicatorHeight = 6.0;
...
/// indicator, see [SMLinearProgressIndicator]. For a circular progress indicator,
...
class _SMLinearProgressIndicatorPainter extends CustomPainter {
  const _SMLinearProgressIndicatorPainter({
    this.backgroundColor,
    this.valueColor,
    this.value,
    this.animationValue,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (value != null) {
      ...
      canvas.drawCircle(Offset(value.clamp(0.0, 1.0) * size.width, 3.0), 8.0, paint);
  ...
  @override
  bool shouldRepaint(_SMLinearProgressIndicatorPainter oldPainter) {
...
class SMLinearProgressIndicator extends ProgressIndicator {
  /// Creates a linear progress indicator.
  ///
  /// {@macro flutter.material.progressIndicator.parameters}
  const SMLinearProgressIndicator({
    Key key,
    double value,
    Color backgroundColor,
  ...
  @override
  _SMLinearProgressIndicatorState createState() => _SMLinearProgressIndicatorState();
}

class _SMLinearProgressIndicatorState extends State<SMLinearProgressIndicator> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SMLinearProgressIndicator oldWidget) {
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        constraints: const BoxConstraints(
          ...
          minHeight: _kSMLinearProgressIndicatorHeight,
        ),
        child: CustomPaint(
          painter: _SMLinearProgressIndicatorPainter(
